  ...
  "inline-flex items-center justify-center whitespace-nowrap",
  {
    variants: {
      variant: {
        ...
        underlined:
          "pb-2 text-neutral-500 text-base font-medium flex gap-2.5 data-[state=active]:text-primary data-[state=active]:border-b-2 data-[state=active]:border-neutral-900 data-[state=active]:pb-[6px]",
      },
    },
    defaultVariants: {
      variant: "default",
